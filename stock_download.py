...
for symbol in tqdm.tqdm(iterable=sp_500_symbols, desc="Downloaded stocks", total=len(sp_500_symbols), unit="stock"):
    try:
        ...
        print(symbol)
        try:
            print("First added date of stock", symbol, "is after the querying start date.", end='')
            ...
            print("..and also the end date. Hence, ignore!\n")
