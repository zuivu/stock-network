...
def get_sp500_close(start_day, end_day, result_csv_dir):
    ...
    sp_500_adj_close_df.to_csv(result_csv_dir)
    return sp_500_adj_close_df

if __name__ == "__main__":
    start_day = "23 Mar, 2020"
    end_day = "03 Jan, 2022"
    download_data_name = "sp500-info.csv"
    sp_500_df = get_sp500_close(start_day, end_day, download_data_name)
